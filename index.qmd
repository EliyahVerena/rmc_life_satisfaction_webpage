...
author: "Verena Poto Tshimbombo" # Remember to add your name!
date: "24-07-2024"
theme: united
---
...
### Happiness across the world over time {.panel-tabset}
...
# Filter the cantril data to just 4 to 8 countries


cantril_filtered <- cantril %>%
  filter(Country %in% c('France', 'Belgium', 'Democratic Republic of Congo', 'Spain', 'United States', 'Gabon')) 

# Create line chart
line_graph <- ggplot(cantril_filtered, 
                     aes(x = `Year`, 
...
# Convert ggplot chart to plotly chart
ggplotly(line_graph)
...
shared_cantril_data <- highlight_key(cantril_filtered)
...
function filter_default() {
  var default_countries = ["Belgium", "Democratic Republic of Congo", "France", "Gabon", "Spain", "united States"]; // Set default countries here
